...
def recording_normalize(recording_file,header_file):
    recording=load_recording(recording_file, header=None, leads=None, key='val')
    header=load_header(header_file)
    recording=1.0*recording
...
# header_files='HR00001.hea'
# header=load_header(header_files)
# get_labels(load_header(header))
# leads=get_leads(load_header(header))
# get_baselines(load_header(header), leads)
# get_adc_gains(load_header(header), leads)
# get_frequency(load_header(header))
# get_sex(load_header(header))
# load_header(header)
# recording_file='HR00001.mat'